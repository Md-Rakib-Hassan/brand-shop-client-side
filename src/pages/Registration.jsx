            ...
            <form onSubmit={handleSubmit} >
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="py-6 text-xl text-gray-400">Welcome to Social Event Management! We are thrilled that you have decided to join our community. To get started, please fill out the registration form below. We look forward to helping you create memorable events and celebrations.</p>
                    </div>
